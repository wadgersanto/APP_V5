...
public class ArrayAdapterDataModelPicking extends ArrayAdapter<DataModelBo> {

    private Context mContext;
    private List<DataModelBo> mListDataModelBO;

    public ArrayAdapterDataModelPicking(Context context, ArrayList<DataModelBo> objects)
    {
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        final ArrayAdapterDataModelPicking.ViewHolderItem viewHolder;
        ...
        if (convertView == null) {
            ...
            viewHolder = new ArrayAdapterDataModelPicking.ViewHolderItem();
            ...
            viewHolder = (ArrayAdapterDataModelPicking.ViewHolderItem) convertView.getTag();
        }
        ...
        if (data != null) {
            ...
            viewHolder.textView_Lin1b.setText("nº "+String.valueOf(data.getObrano()));
            viewHolder.textView_Lin2a.setText(data.getDataobra().substring(0, 10));
