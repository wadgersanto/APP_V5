...
public class ArrayAdapterDataModelSuppliersOpenReceptions extends ArrayAdapter<DataModelBo> {

    private Context mContext;
    private List<DataModelBo> mListDataModelBO;

    public ArrayAdapterDataModelSuppliersOpenReceptions(Context context, ArrayList<DataModelBo> objects)
    {
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        final ArrayAdapterDataModelSuppliersOpenReceptions.ViewHolderItem viewHolder;
        ...
        if (convertView == null) {
            ...
            viewHolder = new ArrayAdapterDataModelSuppliersOpenReceptions.ViewHolderItem();
            ...
            viewHolder = (ArrayAdapterDataModelSuppliersOpenReceptions.ViewHolderItem) convertView.getTag();
        }
        ...
        if (data != null) {
            ...
            viewHolder.textView_Lin1b.setText("nº "+String.valueOf(data.getObrano()).trim());

            if(!data.getVossodoc().trim().isEmpty())
                viewHolder.textView_Lin2a.setText(data.getVossodoc().trim());
            else
                viewHolder.textView_Lin2a.setText("N/A");
