...
public class ArrayAdapterDataModelSuppliersWithOpenOrders extends ArrayAdapter<DataModelBo> {

    private Context mContext;
    private List<DataModelBo> mListDataModelBO;

    public ArrayAdapterDataModelSuppliersWithOpenOrders(Context context, ArrayList<DataModelBo> objects)
    {
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        final ArrayAdapterDataModelSuppliersWithOpenOrders.ViewHolderItem viewHolder;
        ...
        if (convertView == null) {
            ...
            viewHolder = new ArrayAdapterDataModelSuppliersWithOpenOrders.ViewHolderItem();
            ...
            viewHolder = (ArrayAdapterDataModelSuppliersWithOpenOrders.ViewHolderItem) convertView.getTag();
        }
        ...
        if (data != null) {
            ...
            viewHolder.textView_Lin1b.setTextSize(20);
            ...
            viewHolder.textView_Lin1.setText(data.getNome().trim());
            viewHolder.textView_Lin1b.setText("nº "+data.getNo());
            viewHolder.textView_Lin2a.setText("");
            viewHolder.textView_Lin2b.setText("4");
