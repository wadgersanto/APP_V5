...
public class PickingsWithUnreadBoxesWs {

    Context context;
    private ProgressDialog progDailog;

    private OnPickingsWithUnreadBoxes onPickingsWithUnreadBoxes;

    public PickingsWithUnreadBoxesWs(Activity activity) {
        context = activity;
    ...
    public void execute() {
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.GET, uri.toString(), new Response.Listener<String>()
        {
            ...
            public void onResponse(String response)
            {
                ...
                onPickingsWithUnreadBoxes.onWsResponsePickings(supplierOpenOrders);
    ...
    public void setOnPickingsWithUnreadBoxesListener(OnPickingsWithUnreadBoxes onPickingsWithUnreadBoxes) {
        this.onPickingsWithUnreadBoxes = onPickingsWithUnreadBoxes;
    }

    public interface OnPickingsWithUnreadBoxes {
        void onWsResponsePickings(ArrayList<DataModelBo> arrayListDataModelBO);
    }
