...
public class QualityControlGetRefWs {

    Context context;
    private ProgressDialog progDailog;

    private OnQualityControlGetRef onQualityControlGetRef;

    public QualityControlGetRefWs(Activity activity) {
        context = activity;
    ...
    public void execute(String ref) {
        ...
        Uri uri = Uri.parse("http://" + Globals.getInstance().getCaminho() + "/TerminalPHC_INOVEPLASTIKA/Service1.svc/"+ref).buildUpon()
                .build();
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.GET, uri.toString(), new Response.Listener<String>()
        {
            ...
            public void onResponse(String response)
            {
                ...
                onQualityControlGetRef.onWsResponseSuppliersWithOpenOrders(supplierOpenOrders);
    ...
    public void setOnQualityControlGetRef(OnQualityControlGetRef suppliersWithOpenOrders) {
        this.onQualityControlGetRef = suppliersWithOpenOrders;
    }

    public interface OnQualityControlGetRef {
